...
var ball = new Ball(330, 635, 15, 5, 5);
var paddle = new Paddle(300, 650, 300, 15);
var brick = new Brick(null, null);
var game = new Game;
var bricksArray = game.buildBricksArray(6, 2, 20, 240, 50);
...
function startLevelThree() {
  ...
  ball.dY = -5;
  paddle.width = 100;
  bricksArray = game.buildBricksArray(4, 6, 20, 240, 50);
  gameLoop();
}
