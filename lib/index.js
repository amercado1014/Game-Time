...
var ball2 = new Ball(420, 560, 20, 4, 4);
var ball3 = new Ball(420, 560, 10, 5, 5) 
...
var bricksArray3 = brick.buildBricksArray(6, 3);
...
function gameLoop2() {
  ball2.erase(ctx, canvas).drawBall(ctx).bounce(canvas);
...
function gameLoop3() {
  ball3.erase(ctx, canvas).drawBall(ctx).bounce(canvas);
